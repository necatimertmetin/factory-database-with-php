    ...
    <div class="left-container">
      ...
      <div class="left-menu">
        ...
        <div class="left-menu-items">
          ...
          <a class="left-menu-item active" href="../phone/phone.php">
    ...
    <div class="main-container">
      <div class="database-container">
        ...
        <div class="database-top">
          ...
          <a class='add-button' href='../tools/phoneCreate.php' role="button">ekle</a>
              ...
              while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                  <td class='action-button'>
                    <a class='update-button' href='../tools/phoneEdit.php?ID=$row[ID]' role='button'>Update</a>

                    <a class='delete-button' href='../tools/phoneDelete.php?ID=$row[ID]' role='button'>Delete</a>
